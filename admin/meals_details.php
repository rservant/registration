...
$query ="SELECT SQL_CALC_FOUND_ROWS Registrations.Registration_Number, Registration_Confirmation_Number, payment_status, invoice,  Club_Name, Club_Division, Conference_Title_EN, Product_Description, Registration_Paye_Method
