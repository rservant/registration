...
<input name="Product_Description" type="text"  placeholder="Product_Description" value="<?php echo !empty($ProductDescription)?$ProductDescription:'';?>">
 ...
 <div class="control-group <?php echo !empty($ProductEffectiveDateTime)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input name="Product_Effective_Date_Time" type="text"  placeholder="Product_Effective_Date_Time" value="<?php echo !empty($ProductEffectiveDateTime)?$ProductEffectiveDateTime:'';?>" id="p_start">
 ...
 <div class="control-group <?php echo !empty($ProductExpiryDateTime)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input name="Product_Expiry_Date_Time" type="text"  placeholder="Product_Expiry_Date_Time" value="<?php echo !empty($ProductExpiryDateTime)?$ProductExpiryDateTime:'';?>" id="p_end">
