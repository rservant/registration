		...
		<script type="text/javascript" charset="utf-8">
			$(document).ready(function() {
				$('#example').dataTable( {
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "../dtab/view_newreg.php"
				} );
			} );
		</script>
...
<div align="right"><iframe src="menus.php" width="100%" frameborder="0" scrolling="no" height="37"></iframe></div>
			...
			<h1>DETAILS</h1>-->
<div align="right"><a href="fallexport.php" style="color:#ffffff;">Export to Excel</a></div>
<div align="right"><a href="meals_details_fall.php" style="color:#ffffff;">Export to Details</a></div>
			<div id="demo">
