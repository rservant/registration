		...
		<script type="text/javascript" charset="utf-8">
			$(document).ready(function() {
				$('#example').dataTable( {
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "../dtab/view_products.php"
				} );
			} );
		</script>
...
<div id="container">
			<div class="full_width big">
				<font style="color:#ffffff;"><h3>Toastmasters Product Details</h3></font>
<div align="right"><iframe src="menus.php" width="100%" frameborder="0" scrolling="no" height="37"></iframe></div>
			</div>
			
			<h1 style="color:#ffffff;">PRODUCTS DETAILS</h1>
			<!--<p>All Conference.</p>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
	<thead>
		<tr>
			<th width="10%">Product<br />Conference<br />Number</th>
<th width="16%">Product_Title_EN</th>
<th width="16%">Product_Title_FR</th>
			<th width="16%">Product_Description</th>
			<th width="16%">Product_Price</th>
<th width="16%">Start_Date</th>
