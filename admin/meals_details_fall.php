...
, Conference_End_Date
 ...
 = Products.Product_Conference_Number WHERE Conference.conference_category='fall'
...
WHERE Registration_Confirmation_Number != '' AND Conference.conference_category='fall'");*/
...
JOIN Meals AS m ON m.Meal_Id = r.Registration_Meal_Banquet_Identifier
WHERE Registration_Confirmation_Number != '' AND c.Conference_Title_EN = 'District 61 Fall Conference'
GROUP BY Registration_Meal_Banquet_Identifier");
...
header("Content-Disposition: attachment; filename=\"fall_meals_details.xlsx\"");
