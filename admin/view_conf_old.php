		...
		<script type="text/javascript" charset="utf-8">
			$(document).ready(function() {
				$('#example').dataTable( {
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "../dtab/view_conf.php"
				} );
			} );
		</script>
...
<div id="container">
			<div class="full_width big">
				<font style="color:#ffffff;"><h3>Toastmasters Conference Details</h3></font>
<div align="right"><iframe src="menus.php" width="100%" frameborder="0" scrolling="no" height="37"></iframe></div>
			</div>
			
			<h1 style="color:#ffffff;">CONFERENCE DETAILS</h1>
			<!--<p>All Conference.</p>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
	<thead>
		<tr>
			<th width="16%">Conf_Title_EN</th>
			<th width="16%">Conf_Title_FR</th>
			<th width="16%">Conf_Theme_EN</th>
			<th width="16%">Conf_Theme_FR</th>
			<th width="15%">Conf_Start_Date</th>
                        <th width="15%">Conf_End_Date</th>
		</tr>
	</thead>
	<tfoot>
		<tr>
