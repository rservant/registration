...
'payment_status'
   ...
   $sJoin .= ' LEFT JOIN Clubs ON Clubs.Club_Number = Identification.Client_Club_Number';
   $sJoin .= ' JOIN Meals as m1
   ...
   $sJoin .= ' JOIN Conference ON Conference.Conference_Identifier = Products.Product_Conference_Number';
